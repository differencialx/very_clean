...
var baseForOwn = __webpack_require__(/*! ./_baseForOwn */ 315),
    createBaseEach = __webpack_require__(/*! ./_createBaseEach */ 1064);
...
var isArrayLike = __webpack_require__(/*! ./isArrayLike */ 140);
...
/* 1182 */
/*!********************************************************!*\
  !*** ./app/javascript/src/reducers/entitiesReducer.js ***!
  \********************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var _merge = __webpack_require__(/*! lodash/merge */ 1183);

var _merge2 = _interopRequireDefault(_merge);

var _concat = __webpack_require__(/*! lodash/concat */ 1198);

var _concat2 = _interopRequireDefault(_concat);

var _filter = __webpack_require__(/*! lodash/filter */ 1201);
...
function entitiesReducer() {
  ...
  switch (action.type) {
    case TYPES.FETCH_PROJECTS + TYPES.SUCCESS:
      return _extends({}, state, action.data.entities);
    case TYPES.CREATE_PROJECT + TYPES.SUCCESS:
      return (0, _merge2.default)({}, state, action.data.entities);
    case TYPES.UPDATE_PROJECT + TYPES.SUCCESS:
      return _extends({}, state, {
        projects: _extends({}, state.projects, action.data.entities.projects)
      });
    case TYPES.REMOVE_PROJECT + TYPES.SUCCESS:
      var newProjectState = Object.assign({}, state.projects);
      delete newProjectState[action.projectId];
      return _extends({}, state, {
        projects: _extends({}, newProjectState)
      });
    case TYPES.CREATE_TASK + TYPES.SUCCESS:
      return _extends({}, state, {
        projects: _extends({}, state.projects, _defineProperty({}, action.projectId, _extends({}, state.projects[action.projectId], {
          tasks: (0, _concat2.default)(state.projects[action.projectId].tasks, [{ id: action.data.result.tasks.shift(), type: 'task' }])
        }))),
        tasks: (0, _merge2.default)({}, state.tasks, action.data.entities.tasks)
      });
    case TYPES.UPDATE_TASK + TYPES.SUCCESS:
      return _extends({}, state, {
        tasks: _extends({}, state.tasks, action.data.entities.tasks)
      });
    case TYPES.REMOVE_TASK + TYPES.SUCCESS:
      var newTasksState = Object.assign({}, state.tasks);
      delete newTasksState[action.taskId];
      return _extends({}, state, {
        projects: _extends({}, state.projects, _defineProperty({}, action.projectId, _extends({}, state.projects[action.projectId], {
          tasks: (0, _filter2.default)(state.projects[action.projectId].tasks, function (task) {
    ...
    case TYPES.REMOVE_COMMENT + TYPES.SUCCESS:
      var newCommentsState = Object.assign({}, state.comments);
      delete newCommentsState[action.commentId];
      return _extends({}, state, {
        tasks: _extends({}, state.tasks, _defineProperty({}, action.taskId, _extends({}, state.tasks[action.taskId], {
          comments: (0, _filter2.default)(state.tasks[action.taskId].comments, function (comment) {
    ...
    case TYPES.CREATE_COMMENT + TYPES.SUCCESS:
      return _extends({}, state, {
        tasks: _extends({}, state.tasks, _defineProperty({}, action.taskId, _extends({}, state.tasks[action.taskId], {
          comments: (0, _concat2.default)(state.tasks[action.taskId].comments, [{ id: action.data.result.comments.shift(), type: 'comment' }])
        }))),
        comments: (0, _merge2.default)({}, state.comments, action.data.entities.comments)
      });
...
(function () {
  ...
  reactHotLoader.register(initialState, "initialState", "/home/www/very_clean/app/javascript/src/reducers/entitiesReducer.js");
  reactHotLoader.register(entitiesReducer, "entitiesReducer", "/home/www/very_clean/app/javascript/src/reducers/entitiesReducer.js");
  reactHotLoader.register(_default, "default", "/home/www/very_clean/app/javascript/src/reducers/entitiesReducer.js");
  leaveModule(module);
})();
...
var baseMerge = __webpack_require__(/*! ./_baseMerge */ 1184),
    createAssigner = __webpack_require__(/*! ./_createAssigner */ 1189);
...
var Stack = __webpack_require__(/*! ./_Stack */ 205),
    assignMergeValue = __webpack_require__(/*! ./_assignMergeValue */ 1132),
    baseFor = __webpack_require__(/*! ./_baseFor */ 637),
    baseMergeDeep = __webpack_require__(/*! ./_baseMergeDeep */ 1185),
    isObject = __webpack_require__(/*! ./isObject */ 69),
    keysIn = __webpack_require__(/*! ./keysIn */ 316),
    safeGet = __webpack_require__(/*! ./_safeGet */ 1133);
...
var assignMergeValue = __webpack_require__(/*! ./_assignMergeValue */ 1132),
    ...
    isArguments = __webpack_require__(/*! ./isArguments */ 238),
    isArray = __webpack_require__(/*! ./isArray */ 37),
    isArrayLikeObject = __webpack_require__(/*! ./isArrayLikeObject */ 1186),
    isBuffer = __webpack_require__(/*! ./isBuffer */ 206),
    isFunction = __webpack_require__(/*! ./isFunction */ 311),
    isObject = __webpack_require__(/*! ./isObject */ 69),
    isPlainObject = __webpack_require__(/*! ./isPlainObject */ 1187),
    isTypedArray = __webpack_require__(/*! ./isTypedArray */ 314),
    safeGet = __webpack_require__(/*! ./_safeGet */ 1133),
    toPlainObject = __webpack_require__(/*! ./toPlainObject */ 1188);
...
var baseRest = __webpack_require__(/*! ./_baseRest */ 1190),
    isIterateeCall = __webpack_require__(/*! ./_isIterateeCall */ 1197);
...
var identity = __webpack_require__(/*! ./identity */ 364),
    overRest = __webpack_require__(/*! ./_overRest */ 1191),
    setToString = __webpack_require__(/*! ./_setToString */ 1193);
...
var apply = __webpack_require__(/*! ./_apply */ 1192);
...
var baseSetToString = __webpack_require__(/*! ./_baseSetToString */ 1194),
    shortOut = __webpack_require__(/*! ./_shortOut */ 1196);
...
var constant = __webpack_require__(/*! ./constant */ 1195),
    defineProperty = __webpack_require__(/*! ./_defineProperty */ 635),
    identity = __webpack_require__(/*! ./identity */ 364);
...
var arrayPush = __webpack_require__(/*! ./_arrayPush */ 309),
    baseFlatten = __webpack_require__(/*! ./_baseFlatten */ 1199),
    copyArray = __webpack_require__(/*! ./_copyArray */ 317),
    isArray = __webpack_require__(/*! ./isArray */ 37);
...
var arrayPush = __webpack_require__(/*! ./_arrayPush */ 309),
    isFlattenable = __webpack_require__(/*! ./_isFlattenable */ 1200);
...
var arrayFilter = __webpack_require__(/*! ./_arrayFilter */ 636),
    baseFilter = __webpack_require__(/*! ./_baseFilter */ 1202),
...
var baseEach = __webpack_require__(/*! ./_baseEach */ 1061);
...
/* 1203 */
/*!*********************************************************!*\
  !*** ./app/javascript/src/reducers/pageStateReducer.js ***!
  \*********************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
function pageStateReducer() {
  ...
  switch (action.type) {
    ...
    case types.HIDE_PROJECT_FORM_BUTTONS:
      return _extends({}, state, { isProjectFormButtonsVisible: action.visibility });
    default:
      return state;
  }
}

var _default = pageStateReducer;
exports.default = _default;
;
...
(function () {
  ...
  reactHotLoader.register(initialState, 'initialState', '/home/www/very_clean/app/javascript/src/reducers/pageStateReducer.js');
  reactHotLoader.register(pageStateReducer, 'pageStateReducer', '/home/www/very_clean/app/javascript/src/reducers/pageStateReducer.js');
  reactHotLoader.register(_default, 'default', '/home/www/very_clean/app/javascript/src/reducers/pageStateReducer.js');
  leaveModule(module);
})();
...
/* 1204 */
/*!*******************************************************!*\
  !*** ./app/javascript/src/reducers/sessionReducer.js ***!
  \*******************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
function sessionReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !!localStorage.jwt;
  var action = arguments[1];
...
(function () {
  ...
  reactHotLoader.register(sessionReducer, 'sessionReducer', '/home/www/very_clean/app/javascript/src/reducers/sessionReducer.js');
  leaveModule(module);
})();
...
/* 1205 */
/*!********************************************************!*\
  !*** ./app/javascript/src/reducers/authFormReducer.js ***!
  \********************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
(function () {
  ...
  reactHotLoader.register(initialState, 'initialState', '/home/www/very_clean/app/javascript/src/reducers/authFormReducer.js');
  reactHotLoader.register(authFormReducer, 'authFormReducer', '/home/www/very_clean/app/javascript/src/reducers/authFormReducer.js');
  reactHotLoader.register(_default, 'default', '/home/www/very_clean/app/javascript/src/reducers/authFormReducer.js');
  leaveModule(module);
})();
...
/* 1206 */
/*!*******************************************************!*\
  !*** ./app/javascript/src/reducers/loadingReducer.js ***!
  \*******************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
function loadingReducer() {
  ...
  switch (action.type) {
    ...
    case types.REMOVE_COMMENT + types.REQUEST:
      return _extends({}, state, { commentLoading: true });
    case types.FETCH_PROJECTS + types.REQUEST:
      return _extends({}, state, { projectLoading: true });
    case types.CREATE_COMMENT + types.SUCCESS:
    case types.REMOVE_COMMENT + types.SUCCESS:
      return _extends({}, state, { commentLoading: false });
    case types.FETCH_PROJECTS + types.SUCCESS:
      return _extends({}, state, { projectLoading: false });
    default:
      return state;
  }
}
...
(function () {
  ...
  reactHotLoader.register(initialState, 'initialState', '/home/www/very_clean/app/javascript/src/reducers/loadingReducer.js');
  reactHotLoader.register(loadingReducer, 'loadingReducer', '/home/www/very_clean/app/javascript/src/reducers/loadingReducer.js');
  leaveModule(module);
})();
...
var _redux = __webpack_require__(/*! redux */ 214);

var _entitiesReducer = __webpack_require__(/*! ./entitiesReducer */ 1182);

var _entitiesReducer2 = _interopRequireDefault(_entitiesReducer);

var _pageStateReducer = __webpack_require__(/*! ./pageStateReducer */ 1203);

var _pageStateReducer2 = _interopRequireDefault(_pageStateReducer);

var _sessionReducer = __webpack_require__(/*! ./sessionReducer */ 1204);

var _sessionReducer2 = _interopRequireDefault(_sessionReducer);

var _authFormReducer = __webpack_require__(/*! ./authFormReducer */ 1205);

var _authFormReducer2 = _interopRequireDefault(_authFormReducer);

var _loadingReducer = __webpack_require__(/*! ./loadingReducer */ 1206);
...
var reducer = (0, _redux.combineReducers)({
  pageState: _pageStateReducer2.default,
  entities: _entitiesReducer2.default,
  session: _sessionReducer2.default,
  authForm: _authFormReducer2.default,
...
(function () {
  ...
  reactHotLoader.register(reducer, 'reducer', '/home/www/very_clean/app/javascript/src/reducers/index.js');
  reactHotLoader.register(_default, 'default', '/home/www/very_clean/app/javascript/src/reducers/index.js');
  leaveModule(module);
})();
...
/***/ })
/******/ ]);
//# sourceMappingURL=index-beab49c0d9daf1ca89c0.js.map